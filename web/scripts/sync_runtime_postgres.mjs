    ...
    await client.query(
      `
        ...
        DO UPDATE SET
          ...
          optimizer_session_id = EXCLUDED.optimizer_session_id,
          optimizer_target_return_lift_pct = EXCLUDED.optimizer_target_return_lift_pct,
          optimizer_best_score = EXCLUDED.optimizer_best_score,
          optimizer_target_met = EXCLUDED.optimizer_target_met,
          epoch_library_confidence_schema = EXCLUDED.epoch_library_confidence_schema,
          epoch_library_status = EXCLUDED.epoch_library_status,
          updated_at = NOW()
      `,
      [
        runId,
