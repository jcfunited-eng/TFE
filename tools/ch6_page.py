...
def build_page() -> ChannelPage:
    ...
    return ChannelPage(
        ...
        rules=(
            ...
            "A winner arms at 5%, tracks its best observed gain, and harvests after giving back more than one percentage point; the end-of-day sweep banks positions at 2% or better (Joseph's fast-cash law). Positions size to $2,500 per entity maximum (Joseph 2026-08-20), best-ranked first across as many entities as supply and cash allow, capped at 1% of each entity's normal-day traded money. Funds and baskets are the zombie category and are refused: operating companies only.",
