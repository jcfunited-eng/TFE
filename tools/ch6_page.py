...
def build_page() -> ChannelPage:
    ...
    return ChannelPage(
        ...
        rules=(
            ...
            "A winner arms at 5%, tracks its best observed gain, and harvests after giving back more than one percentage point; the end-of-day sweep banks positions at 2% or better (Joseph's fast-cash law). Positions size to $60,000 capped at 1% of the entity's normal-day traded money.",
