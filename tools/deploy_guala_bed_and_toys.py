"""Her-Room Spatial Geometry and Caretaker Domestic Mobility release, one image, one definition, one writer cutover.

Includes full release:
- Her-room spatial geometry overhaul (bed northwest corner, wall art mounted on west wall, desk southeast corner, curtains on north window, playpen northeast quadrant).
- Caretaker domestic circulation and accompanying presence across domestic zones.
- Grounded episodic pursuit and 250ms turn-taking quiet-gap release.
...
OLD_TASK = "9011708ff64d48988de77fd2265b4a3a"
OLD_DEFINITION = "arn:aws:ecs:us-east-1:418384447921:task-definition/dsf-ai-task:1552"
BASE = ACCOUNT+".dkr.ecr."+REGION+".amazonaws.com/dsf-ai@sha256:d6e6c3e4dd429703cda953161d4a0e93e7bf145fdf5238636311a09d6997cd98"
REPOSITORY = BASE.split("@")[0]
FILES = {
 "dsf_ai_service/substrate/embodiment_world.py": "b84cee84317be82ea82d1995454c07475bddd932608e76851a6a61bdb12b7811",
 ...
 "dsf_ai_service/guala_home_world.py": "cfc77ed5e3e998562298ee74a98a435e38affa9a2ff51c53518e74593c25120e",
...
def main():
    ...
    context=Path(tempfile.mkdtemp(prefix="a1-bedtoys-build-"))
    ...
    tag=REPOSITORY+":a1-bedtoys-"+commit[:12]
