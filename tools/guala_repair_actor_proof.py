"""Repair-only ordinary actor proof on one authenticated disposable live pair."""
import base64
...
root = Path(tempfile.mkdtemp(prefix="a1-repair-proof-"))
...
print("REPAIR_ONLY_MATURE_CAUSAL_PERSISTENCE_FRESH_PROCESS_PASS", flush=True)
