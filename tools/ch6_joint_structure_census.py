"""
ch6_joint_structure_census.py — the structures that pay, read jointly
=====================================================================
...
Usage:  python tools/ch6_joint_structure_census.py
Output: artifacts/ch4_uf/ch6_joint_structure_census.json (+ events
        parquet beside it)
"""
...
OUT = os.path.join(ROOT, "artifacts", "ch4_uf",
                   "ch6_joint_structure_census.json")
