...
\hline
Document ID & TFE-DSFAI-SPEC-2.4 \\\hline
Version & 2.4 (code-truth L5 integration, CP-0/CP-1/CP-2 conformance profiles, competitiveness ceiling analysis, lineage appendices, fallback/provenance doctrine, and eco-efficient L5 compute profiles) \\\hline
...
\begin{enumerate}[leftmargin=1.2cm]
    ...
    \item Runtime tables currently preserve full snapshot rows but do not persist all decision-provenance fields as first-class columns.
    \item Candidate-key fallback chains relax exact structural matching to preserve coverage.
\end{enumerate}
These transform points do not invalidate CP-0, but they do impose a competitiveness ceiling and motivate CP-1/CP-2 work.
