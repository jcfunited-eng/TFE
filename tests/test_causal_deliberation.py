...
def test_exact_outcome_advances_a_multi_step_chain() -> None:
    ...
    second_action = ActionCommand.speech("two")
    _learn_transition(
        cycle,
        first,
        first_action,
...
def test_terminal_reopens_when_verified_relation_state_changes() -> None:
    ...
    action = ActionCommand.speech("learned")
    _learn_transition(
        cycle,
        field,
        action,
...
def test_relation_and_outcome_storage_plateaus_at_hard_bounds() -> None:
    ...
    for index, field in enumerate(fields):
        _teach(
            cycle,
            field,
            ActionCommand.speech(f"action-{index}"),
    ...
    _teach(
        cycle,
        sixth,
        ActionCommand.speech("action-sixth"),
