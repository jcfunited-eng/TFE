...
class CausalExperienceSettlement:
    ...
    def verify(self) -> None:
        ...
        native_registry = self.native_evidence_witness.registry()
        witness_ports = {
            (
                value.sense,
...
class VerifiedCausalSettlementCapability:
    """Request-local identity authority for one active exact settlement."""
        ...
        *,
        ...
        with self._lock:
            ...
            native_evidence_witness = (
                self._native_evidence_custody.admit(
                    NativeEvidenceCustodyWitness.from_built(built)
                )
            )
