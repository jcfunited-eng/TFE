...
PACE_VARIATION = 0.07
FADE_MS = 24
ONSET_MS = 60                            # a closed-lips murmur before the vowel
...
def syllable_pcm(drive: tuple[int, int, int], seed: int) -> bytes:
    ...
    # The throat: three gliding formants (murmur to vowel over the onset), then F4/F5.
    ...
    if onset:
        # Closed lips: a real lowpass and a lower level for the murmur span.
...
__all__ = ("ONSETS", "PITCHES_DECIHERTZ", "VOWELS", "syllable_pcm")
