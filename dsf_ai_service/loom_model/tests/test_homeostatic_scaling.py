...
def test_zero_lines_touched_in_v5_engine():
    """This entire feature must live inside dsf_ai_service/loom_model/
    only. Confirms via git that gualaloom_v5_engine.py has no diff
    against origin/guala-live -- i.e. this addition created no new call
    site in the old-system engine file."""
