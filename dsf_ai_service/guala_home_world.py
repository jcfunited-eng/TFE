...
def _home_rooms_and_things() -> tuple[list[Any], list[Any], list[Any]]:
    ...
    furniture = (
        ...
        ("table",           2_000,  1_500,     0, 850, 28_000, (700_000, 620_000, 520_000, 450_000, 410_000, 390_000)),
        ("table-chair",     2_000,  3_000,     0, 320,  6_000, (300_000, 260_000, 240_000, 220_000, 210_000, 200_000)),
        ("bowl",            4_500,    800,     0, 160,    700, (920_000, 910_000, 900_000, 880_000, 860_000, 840_000)),
        ("cup",             5_200,    800,     0, 110,    300, (880_000, 870_000, 860_000, 840_000, 820_000, 800_000)),
        ("apple",           5_650,    900,     0,  90,    180, (820_000, 260_000, 190_000, 170_000, 160_000, 150_000)),
        # her room: bed wall, soft things, desk corner, art at eye height, stars on the ceiling.
        ("bed",             1_200,  8_800,     0, 900, 40_000, (760_000, 720_000, 690_000, 640_000, 600_000, 560_000)),
        ("pillow",          1_200,  7_600,     0, 260,  1_200, (900_000, 890_000, 880_000, 860_000, 840_000, 820_000)),
        ("blanket",         3_400,  9_300,     0, 300,    900, (860_000, 620_000, 540_000, 500_000, 470_000, 450_000)),
        ("toy-bear",        4_800,  9_200,     0, 180,    400, (520_000, 380_000, 300_000, 260_000, 240_000, 220_000)),
        ("toy-chest",       1_000,  5_600,     0, 500,  8_000, (560_000, 430_000, 340_000, 300_000, 280_000, 260_000)),
        ("desk",            2_800,  6_000,     0, 800, 32_000, (430_000, 330_000, 260_000, 220_000, 200_000, 190_000)),
        ("desk-chair",      3_950,  6_000,     0, 320,  6_000, (300_000, 260_000, 240_000, 220_000, 210_000, 200_000)),
        ("curtains",        2_800,  9_700, 1_400, 250,  1_500, (930_000, 760_000, 620_000, 540_000, 500_000, 470_000)),
        ("wall-art-shapes",   150,  7_500,   800, 150,    600, (950_000, 300_000, 850_000, 200_000, 750_000, 250_000)),
        ("wall-art-weather",  150,  6_500,   800, 150,    600, (350_000, 550_000, 900_000, 400_000, 650_000, 300_000)),
        ("glow-stars",      2_200,  8_000, 2_500, 120,    300, (940_000, 930_000, 700_000, 400_000, 300_000, 260_000)),
        # library: shelves on the north wall, the reading lamp, a book home on the shelf.
        ("shelf-a",        10_000,  9_500,     0, 400, 30_000, (500_000, 400_000, 330_000, 290_000, 270_000, 250_000)),
        ("shelf-b",        12_500,  9_500,     0, 400, 30_000, (500_000, 400_000, 330_000, 290_000, 270_000, 250_000)),
        ("book",           10_000,  9_500,   600, 140,    900, (640_000, 520_000, 420_000, 360_000, 330_000, 310_000)),
        ("lamp",           13_500,  5_400,     0, 180,  2_200, (880_000, 850_000, 780_000, 700_000, 650_000, 620_000)),
        # tv room: the watching place.
        ("television",     17_000,  9_200,     0, 700, 12_000, (140_000, 140_000, 150_000, 160_000, 170_000, 180_000)),
        ("radio",          15_400,  9_400,     0, 150,  1_200, (250_000, 240_000, 230_000, 220_000, 210_000, 200_000)),
        ("sofa",           17_000,  6_800,     0, 950, 45_000, (360_000, 330_000, 380_000, 420_000, 430_000, 420_000)),
        ("rug",            15_000,  6_000,     0, 600,  5_000, (540_000, 420_000, 360_000, 330_000, 320_000, 310_000)),
        # dining room: relaid north to leave the corridor into daddy's room unobstructed.
        ("dining-table",   10_200,  3_800,     0, 900, 30_000, (700_000, 620_000, 520_000, 450_000, 410_000, 390_000)),
        ("dining-chair",    8_900,  3_800,     0, 320,  6_000, (300_000, 260_000, 240_000, 220_000, 210_000, 200_000)),
        # backyard: slide, swing, sandbox, garden patch under the sky.
        ("slide",           3_000, 13_500,     0, 900, 25_000, (700_000, 720_000, 740_000, 700_000, 650_000, 600_000)),
        ("swing",           7_000, 14_000,     0, 700, 15_000, (480_000, 430_000, 380_000, 340_000, 320_000, 300_000)),
        ("sandbox",        11_500, 13_500,     0, 1_100, 60_000, (820_000, 780_000, 700_000, 620_000, 560_000, 520_000)),
        ("garden-patch",   16_500, 13_500,     0, 1_200, 80_000, (300_000, 380_000, 300_000, 260_000, 240_000, 220_000)),
    )
    ...
    objects = [
        ...
        for name, x, y, z, radius, mass, reflectance in furniture
    ]
    ...
    for name, x, y, z, *_rest in furniture:
