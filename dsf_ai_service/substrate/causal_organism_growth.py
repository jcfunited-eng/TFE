...
class CausalOrganismGrowthJournal:
    ...
    def admit_episode(
        ...
        *,
        ...
        newly_journaled_values: list[CausalOrganismGrowthClaim] = []
        for value in observations:
            if (
                value.contributes_division_energy
                and value.claim_id not in known
            ):
                newly_journaled_values.append(value)
                known.add(value.claim_id)
        newly_journaled = tuple(newly_journaled_values)
