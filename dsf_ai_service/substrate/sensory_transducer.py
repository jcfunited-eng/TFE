...
# at commit bfdad9a (GL-CMD-F1-SENSORY-TRANSDUCER-EVE-20260621-107),
# which never merged to guala-live. Brought over 2026-07-03 as a
# test-suite dependency repair (unblocks loom_model/tests/
# test_cognition_path.py's import chain), per Eve's ruling on
# GL-CMD-ATTEND-GROOVE-EVE-20260703-107-v2's S2 follow-up. This is
# suite repair only — it is NOT wired into her live sensory path,
# which still runs the dict-seeded TOUCH/SMELL/TASTE generators.
# Whether her live path adopts this transducer is an open Eve+Joe
# design question (see GL-KB-COGNITION-ARC-RECOVERED-EVE-20260703-v2
# §2.7), not decided by this commit.
"""
