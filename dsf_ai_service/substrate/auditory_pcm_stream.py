...
PCM_RING_SECONDS = 8
PCM_TRANSPORT_UNITS = 4
PCM_RING_SAMPLES = PCM_RING_SECONDS * PCM_SAMPLE_RATE_HZ
PCM_CHUNK_SAMPLES = PCM_RING_SAMPLES // PCM_TRANSPORT_UNITS
PCM_MAX_CHUNK_SAMPLES = PCM_RING_SAMPLES
