...
### 300-name pooled (FULL300)

Running at file time (started 18:53 UTC, 10 cohorts); result to be
appended raw when complete.
...
- Three declared shots, three honest misses (gate: home-field
  signature does not replicate on virgin names; lifetime-drain:
