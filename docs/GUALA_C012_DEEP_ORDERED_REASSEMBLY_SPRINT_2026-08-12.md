...
- Active delivery-ledger item: **C-012** — prove relationships among ordered
  formations can persist as tapestry-of-tapestry thought/expressive structure
  without a sequence database.
- Closed predecessor: **C-011**, live-proven on `dsf-ai-task:1001`, release
  commit `c1f7d78e65b8224dcd709f0a5a920eb0108a5d1b`, image
...
7. **Field loss:** none. This work changes only downstream sparse electrical
   propagation evidence and neither copies nor reduces DSF.
...
- Jun and Jin (2007), temporally precise sequences and self-organized synfire
  propagation: <https://pmc.ncbi.nlm.nih.gov/articles/PMC1933597/>.
- Manohar et al. (2019), short-lived synaptic traces as activity-silent working
  state: <https://pmc.ncbi.nlm.nih.gov/articles/PMC7282629/>.
- Ecker et al. (2022), structured recurrent interactions and sequential replay:
  <https://pmc.ncbi.nlm.nih.gov/articles/PMC8865846/>.
