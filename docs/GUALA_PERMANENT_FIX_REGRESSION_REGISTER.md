...
| F-004 | **Reopened 2026-08-28.** Coincidence-based layer-11 to motor/articulatory fan-out was removed on task 1248, but the later root-yaw bootstrap again treated unrelated preceding layer-11 cells as motor-authoring evidence. The local V33 candidate removes that exception and re-runs the one-way cleanup on the same organism. | Authoring every simultaneous or merely preceding ordering/motor pair; guided movement as contact authority; restart restoration of the removed contacts. | Require the exact two-interval ordering -> affective -> regulation chain for every learned motor contact, including root yaw; migrate V32 -> V33; verify the layer-11/layer-12 and historical layer-13 pools stay absent across unattended live intervals and restart. | Local source and restart proofs pass; production task 1283 remains V32 and is **not yet corrected**. Do not cite the task-1248/1280 closure as current proof. |
