# 01 PHYSICS — the deepest roots
The field other fields stand on. Nearly every CANNOT in every other
file traces back to a line in this one.

ESSENCE: energy is never created or destroyed, only moved or changed
...
ASKED-AS: battery fuel gas motor generator perpetual motion electricity power bill charging solar

ESSENCE: disorder wins on its own. Heat flows hot to cold, never the
  reverse without paid work; every real process wastes some energy as
  scattered heat.
...
THREAD: cooking (the egg never un-cooks), cleaning (rooms dirty
  ...
  draws more than it gives — this law may be why).
ASKED-AS: coffee cream ice melting rust aging room clutter cold cup fridge dust

ESSENCE: a thing keeps doing what it is doing unless pushed. Change
  of motion needs a push, and the push works both ways — you cannot
...
ASKED-AS: car seatbelt brake cart slippery ice gun kick jump swing skateboard
...
ASKED-AS: falling weight jump apple drop satellite planet roof ladder skydiving heavy

ESSENCE: waves add. Two waves in the same place sum — crest on
...
ASKED-AS: ripples pond echo speakers hum surf splash overlap tuning fork chorus

ESSENCE: like charges push, opposites pull, and a moving charge
...
ESSENCE: matter comes in discrete pieces — atoms — and the pieces
  come in ~90 natural kinds; everything material is arrangements of
  them.
...
ASKED-AS: dust powder salt sugar molecule element mixture melting grinding smallest stuff

ESSENCE: no two matter-particles of the same kind may occupy the
...
ESSENCE: nothing carrying mass or news outruns light in vacuum
...
ASKED-AS: dice random electron atom tiny fuzzy blur measuring uncertainty coin flip
