# 74 COGNITIVE SYNTAX — the grammar of moves in an exchange

Not the grammar of sentences: the grammar of what may follow
...
ESSENCE: a turn is a move, and moves come in kinds — an opening
  puts a question into the air, an answer closes or widens one, a
...
ESSENCE: a question put into the air stays standing until
...
ESSENCE: a thin thing said leans on the thread — "why?" or "that"
  or "and?" carry almost no ground of their own, so they take up
...
ESSENCE: every move costs something — saying a thing commits you
  to it, closes ground you could have stood on, and can be wrong
...
ESSENCE: saying nothing is a lawful move. When nothing that
  stands would open anything, silence changes neither shape and
...
ESSENCE: what has been said in this thread is spent — repeating
...
ESSENCE: a refusal that does not name what is missing is a dodge.
  To refuse honestly is to say which knowledge, act or ground is
  absent.
...
ESSENCE: a claim must be carried by knowledge that stands; what
  is said without knowledge behind it is not a weaker claim, it
...
ESSENCE: the kind of asking sets the kind of answer — a why-
  asking wants a cause, a what-asking wants a naming, a can-you
...
ESSENCE: after a move, whether it landed is worth checking — the
...
ESSENCE: taking a turn is a procedure, and it runs the same way
  every time.
