# 52 DEEP COLUMN — THE KITCHEN'S SLOW CHEMISTRY
Middle floors for what food does while nobody is cooking it — the
pantry's patient reactions. Still essences, never data; every entry
carries its cannot-twin.

ESSENCE: bread going stale is not drying — cooked starch, jumbled
  soft by the oven, slowly recrystallizes back toward order and
  firms the crumb even inside a sealed bag; a brief reheat melts the
...
ESSENCE: a cut apple browns because the knife breaks its cells and
  lets a caged enzyme, its fuel, and the air's oxygen finally meet —
  a build, not a rot; lemon juice slows it because the enzyme balks
  at acid.
...
ESSENCE: fat goes rancid because oxygen gnaws at its loose joints
  and snaps it into small smelly fragments — light, warmth, and bare
  metal hurry the gnawing, so oil lives longest sealed, dark, and
  cool.
...
ESSENCE: honey never spoils because it is nearly waterless sugar
  (~17% water) laced with acid — a microbe landing on it has its own
...
THREAD: survival (jam, jerky, salt pork — preserving is water
  ...
  sound as chemistry).
ASKED-AS: honey jar spoil forever crystallized grainy hard mead expire pantry sugar

ESSENCE: the room's air holds one level of dampness and every open
  food walks toward it from its own side — a chip is drier than the
  air, drinks, and goes limp; a cut loaf is wetter, exhales, and
...
ESSENCE: leftovers taste different because the pot keeps working in
  the cold — flavors go on crossing and evening all night (the
  stew's marriage), while reheated meat's fat is already breaking
...
ESSENCE: freezer burn is ice leaving without melting — frozen water
  quits the food's surface grain by grain as vapor and re-lands as
  frost on colder coils, leaving the surface freeze-dried: pale,
...
THREAD: mountains (snowbanks shrinking in dry cold without a drip of
  ...
  purpose).
ASKED-AS: freezer burn ice crystals meat white patches dry wrapped bag safe eat frost

ESSENCE: milk curdles in some coffee because acid does to protein
  what heat does to egg — coffee is mildly acid and hot, and milk
  even a day older has quietly soured toward the clumping line, so
...
ESSENCE: the fridge is a brake, not a wall — cold slows nearly all
  of this (roughly half speed per 10°C colder, as a rough rule) but
  above freezing stops none of it; everything inside is aging in
  slow motion.
