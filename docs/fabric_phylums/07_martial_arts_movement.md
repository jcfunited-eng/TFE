# 07 MARTIAL ARTS AND HUMAN MOVEMENT — physics argued between two bodies
Every art's secret teaching is a physics line found by centuries of
bruises. The equipment is the body; the referee is the ground.

ESSENCE: you stand only while your weight stays above your feet —
  balance is keeping the center over the base, and every throw is
...
ASKED-AS: tripping wrestling judo tightrope ladder leaning tipping wobbly shoving sumo standing knocked

ESSENCE: a joint is a hinge with two handles — short for its
  owner, long for whoever holds the far end; small force at the
...
ASKED-AS: armbar wristlock elbow twist grip submission handshake finger escape holding tap wrestling

ESSENCE: the opponent's push is a gift — steer what already moves
  instead of stopping it, add your little to his much, and his
...
ASKED-AS: judo aikido redirect charging bull sidestep dodge counter flip tugging yielding slip

ESSENCE: structure beats muscle — bones stacked in line pass force
  into the ground like a wall stud, while a bent frame must fight
...
ASKED-AS: posture lifting straight back knees squat deadlift stacking bracing slouching heavy carry

ESSENCE: distance and timing are the real weapons — every strike
  has a range where it lives and a beat when the door is open;
  outside those, the best technique is theater.
...
ASKED-AS: reach boxing jab fencing spacing footwork closing gap counter opening dodging stepping

ESSENCE: relaxation is speed — every joint has a fold-muscle and a
  straighten-muscle, and clenching both parks the limb; the fast
...
ASKED-AS: tense stiff whip snap flick swinging effortless smooth jerky punching tension flow

ESSENCE: the ground is the third fighter and the last one standing
  — every fall is a strike thrown by the planet, and the falling
  arts (slap, roll, spread) exist because the floor hits harder
  than any man.
...
ASKED-AS: slipping tripping landing tumbling concrete ice hip elderly parachute mats gymnastics crash

ESSENCE: a punch is thrown by the ground — force starts at the
  foot's push, turns through the hips, and leaves by the fist; the
...
THREAD: sports (pitch, drive, serve — one whip, different balls),
  ...
  last).
ASKED-AS: rotation swing baseball golf legs core torque twisting bat throwing shoulder wind

ESSENCE: practice rewires before it strengthens — repetition moves
  a movement from the slow deliberate track to the fast automatic
...
ASKED-AS: muscle memory training reps habits choking freezing panic instinct rehearsal sparring nerves

ESSENCE: every attack spends the guard that made it — a striking
  limb is absent from defense, so offense and safety draw on one
...
ASKED-AS: openings dropped hands exposed risking trade chin blocking committed vulnerable shell swing
