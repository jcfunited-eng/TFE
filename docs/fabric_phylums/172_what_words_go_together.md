# 172 WHAT WORDS GO TOGETHER — the company a meaning keeps
Words arrive in crowds. Nobody says oven without soon saying heat or
dough, and nobody says solder without wire being somewhere near. A
word alone is a menu of possible meanings; a word standing in one of
these crowds has already been served one. This file writes the crowds
down, so a sentence can be placed by the company it keeps.

ESSENCE: the kitchen is a small workshop for heat and cutting, and
  its words come in three crowds — the tools, the stuff, and the
  doings. Any two of them in one line places the sentence in a
...
ASKED-AS: kitchen words cooking pan oven flour dough chop simmer bake company

ESSENCE: the workshop runs on holding, cutting and joining. Its
  words are almost all nouns for tools and verbs for what tools do,
  and the tell is that the materials named are stock sizes rather
  than living things.
...
ASKED-AS: workshop words tools vice clamp chisel saw drill timber bench making

ESSENCE: the garden joins living things to soil and weather. Its
  crowd mixes plant parts with tools and with the calendar, and the
  presence of a season word beside a plant word is nearly a
  signature.
...
ASKED-AS: garden words seed soil compost spade prune weeds lawn planting growing

ESSENCE: the road is vehicles, surfaces and rules. Its crowd is
  unusual in mixing hardware with law — junction and give way sit
  beside tyre and brake — because driving is a physical act under a
  written code.
...
ASKED-AS: road words driving lane junction traffic brake tyre motorway roundabout rules

ESSENCE: the sea is water, wind and vessels, and its vocabulary is
  older and more specific than almost any other — port, stern, keel
...
ASKED-AS: sea words sailing ship hull keel tide anchor harbour navigation boat

ESSENCE: the sky holds two crowds that share one space — weather
  below and flight above. Cloud, front and gust are the first;
  altitude, wing and airspeed the second; and both are read against
  pressure.
...
ASKED-AS: sky words weather cloud front altitude wind aircraft pressure flying above

ESSENCE: the body has three crowds — the outside parts, the inside
  systems, and what the body does. A part name beside a doing word
  is nearly always literal; a part name alone is very often a
...
ASKED-AS: body words anatomy heart lung muscle bone skin breathing parts inside

ESSENCE: illness talk has three crowds — what the patient reports,
  what an examiner finds, and what the condition is called. Mixing
  the first two is the commonest error in the whole field, and the
...
ASKED-AS: illness words symptom sign fever pain rash diagnosis infection patient medical

ESSENCE: money words split into what is held, what moves, and what
  it is measured against. The tell is that money language is nearly
  all borrowed — flow, liquid, crash, bubble — so the pictures are
...
ASKED-AS: money words cash account balance payment interest loan price bank financial

ESSENCE: law language names parties, documents and outcomes, and it
  is unusually strict about its own terms — every serious agreement
  begins by defining them, precisely because ordinary words drift
...
ASKED-AS: law words contract clause court judge verdict damages legal party ruling

ESSENCE: school words name a place, a schedule and a measurement.
  The schedule crowd — term, period, year, class — is the most
  borrowed part, so the marker for school is usually a pupil word or
...
ASKED-AS: school words pupil teacher lesson exam grade homework classroom term learning

ESSENCE: music has three crowds — pitch words, time words, and
  performance words — and they are almost all technical, which makes
  them very reliable. Key, note, scale, bar and rest all mean other
...
ASKED-AS: music words note key scale chord bar beat tempo playing instrument

ESSENCE: building words name loads, materials and stages. The stage
  crowd is the giveaway — footing, frame, roof, fit-out — because it
...
ASKED-AS: building words foundation beam brick mortar concrete roof structure construction site

ESSENCE: farming words are seasonal, and the season crowd is what
  marks them. Sow, tend, harvest and store is an order that cannot
  be rearranged, and any two of those words together place the
  sentence on land.
...
ASKED-AS: farming words crop field soil harvest sow yield livestock pasture agriculture

ESSENCE: weather words describe air doing three things — moving,
  holding water, and changing pressure. Front, depression and ridge
  are the technical crowd; rain, wind and cloud are the everyday
...
ASKED-AS: weather words rain wind cloud forecast storm pressure front temperature humidity

ESSENCE: applying heat to food has its own crowd, and the divisions
  are physical — whether the carrier is air, fat, water or steam,
  and whether the temperature can pass the boiling point. Brown and
...
ASKED-AS: cooking heat words roast fry boil simmer steam braise browning searing temperature

ESSENCE: cold storage is one idea — slowing life and chemistry down
  — and its words divide by how far down. Chilled slows spoilage,
  frozen stops most of it, and thawing is where the danger sits
...
ASKED-AS: cold storage words fridge freezer frozen thaw preserve spoilage shelf life

ESSENCE: cleaning words name the dirt, the agent and the method, and
  the method crowd is the useful one — wipe, rinse, scrub and
  dissolve are four different physical events with four different
  failures.
...
ASKED-AS: cleaning words dust grease stain soap detergent bleach scrub rinse mop

ESSENCE: sewing words name cloth, joins and shapes. It is a small
  vocabulary that almost never appears anywhere else — hem, seam,
  baste, selvedge — which makes any one of them a strong marker on
  its own.
...
ASKED-AS: sewing words fabric seam hem stitch needle thread pattern cloth tailoring

ESSENCE: writing words split between the making and the shaping —
  draft, edit, cut is the making; paragraph, clause, sentence the
  shaping. Almost every shaping word is also a word in law,
...
ASKED-AS: writing words draft edit paragraph sentence chapter proof revise publish prose

ESSENCE: computer words are almost all borrowed from an office —
  file, folder, desktop, window, memory — which means every one of
  them has a strong everyday sense. Two together is the only safe
  reading.
...
THREAD: words and meaning (66: metaphor grows vocabulary without
  ...
  index).
MEANS-SAME: file folder disk drive backup memory database cache | program process boot crash install update server thread | network router packet server address download upload cloud
ASKED-AS: computer words file folder disk memory program server network software crash

ESSENCE: electricity words are unusually reliable because most were
  minted for the job — volt, amp, ohm, capacitor. The borrowed ones
  are the dangerous half: current, charge, ground, lead and earth
...
ASKED-AS: electricity words volt amp circuit wire fuse battery current resistance wiring

ESSENCE: plumbing words are about water under pressure and water
  under gravity, and the two halves have different vocabularies —
...
ASKED-AS: plumbing words pipe drain valve tap water pressure leak trap blocked

ESSENCE: animal words divide into kinds, parts and doings, and the
  parts crowd is the reliable one — hoof, beak, fin and feather
...
ASKED-AS: animal words hoof beak feather fur mammal bird breed herd wildlife

ESSENCE: plant words split into parts, kinds and conditions, and
  root, stem, bulb and shoot are all heavily borrowed elsewhere. The
...
ASKED-AS: plant words root stem leaf bud shoot species wilting blight garden

ESSENCE: rock words name kinds, structures and processes, and the
  process crowd is what makes them geology rather than decoration —
  bedding, faulting, weathering and intrusion are all statements
  about time.
...
ASKED-AS: rock words granite limestone strata fault sediment mineral geology layers erosion

ESSENCE: star words split into objects, measures and motions. The
  measures are the giveaway — light year, magnitude, parallax and
  redshift belong nowhere else — while orbit, phase and body are
  borrowed constantly.
...
ASKED-AS: star words planet galaxy orbit telescope magnitude lightyear astronomy sky night

ESSENCE: war words name forces, ground and acts. The ground crowd is
  the most telling — flank, salient, line and rear are positions
...
ASKED-AS: war words troops battle flank front advance retreat siege army military

ESSENCE: game words name the players, the field and the scoring, and
  the scoring crowd is the reliable one — innings, set, frame and
  fixture belong to games and nowhere else, while match, round and
...
ASKED-AS: game words player team score referee pitch match round league sport

ESSENCE: travel words name the leg, the paper and the place. Ticket,
  visa, boarding and itinerary are almost unborrowed and settle a
...
ASKED-AS: travel words flight ticket passport booking luggage terminal departure journey abroad

ESSENCE: birth and death are the two ends and share one crowd of
  words about registers and rites. The medical half is precise; the
  ceremonial half is old, and both appear in the same paragraph more
...
ASKED-AS: birth death words labour delivery newborn funeral burial grief certificate registered

ESSENCE: family words are relationship words, and they carry no
  other sense at all — mother, cousin, in-law, sibling. That makes
  them among the most reliable markers there are, and it is why they
...
ASKED-AS: family words mother father cousin sibling relatives kinship married household relations

ESSENCE: work words name the role, the arrangement and the trouble.
  Shift, rota, notice and overtime are unborrowed and reliable;
  position, terms and cover are not, and appear in law and clothing
  and insurance.
...
ASKED-AS: work words job employee wage shift manager contract overtime dismissal employment

ESSENCE: buying and selling has three crowds — the offer, the money
  and the aftermath. Refund, warranty and receipt belong to trade
...
ASKED-AS: buying selling words price quote discount invoice receipt refund warranty purchase

ESSENCE: measuring words name the instrument, the unit and the
  doubt. The doubt crowd is the professional one — tolerance,
  uncertainty, calibration, margin — and its presence marks a
...
ASKED-AS: measuring words ruler gauge unit metre accuracy tolerance calibration precision measurement

ESSENCE: time words divide into points, stretches and repeats.
  Deadline and instant are points; term, spell and stretch are
  durations; daily, weekly and rota are repeats — and mixing them up
...
ASKED-AS: time words deadline duration schedule daily weekly period moment date frequency

ESSENCE: engine words name the cycle, the parts and the faults, and
  the cycle crowd is unmistakable — intake, compression, ignition,
...
ASKED-AS: engine words piston cylinder valve ignition exhaust misfire overheating motor mechanic

ESSENCE: flight words are about a machine balanced in a fluid.
  Airspeed, stall, yaw and trim belong to nothing else; approach,
  lift, ceiling and bank are borrowed constantly and need a
  companion.
...
ASKED-AS: flight words aircraft lift drag stall runway landing pilot airspeed flying

ESSENCE: hospital words name places, roles and stages of care. Ward,
  triage, discharge and theatre are strong markers; admission,
...
ASKED-AS: hospital words ward nurse consultant theatre triage discharge patient clinic emergency

ESSENCE: the factory floor names lines, batches and quality. Batch,
  lot, shift, yield and defect together make a signature that no
...
ASKED-AS: factory words production line batch defect quality shift machine manufacturing throughput

ESSENCE: office words name papers, meetings and hierarchy, and
  almost every one is borrowed — file, board, minutes, chair, brief.
  It is one of the least reliable companies in the language on any
  single word.
...
ASKED-AS: office words memo minutes agenda meeting report manager department filing administration

ESSENCE: worship and rite name gatherings, objects and calendars.
  The calendar crowd is the strong one — feast, fast, vigil,
...
ASKED-AS: worship words prayer service congregation altar scripture festival fasting ritual religious

ESSENCE: the forest is a crowd of tree words, layer words and
  management words. Canopy, understorey and coppice are unborrowed
...
ASKED-AS: forest words trees canopy woodland timber felling coppice conifer broadleaf woods

ESSENCE: the mountain names heights, hazards and routes. Ridge,
  couloir, scree and col belong nowhere else; face, pass, summit and
...
ASKED-AS: mountain words summit ridge climbing altitude ascent avalanche scree peak alpine
