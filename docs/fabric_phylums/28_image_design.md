# 28 IMAGE AND DESIGN — the eye under management
Every picture is built for an organ with fixed habits. Design is
those habits, obeyed on purpose.

ESSENCE: the eye goes where difference is — light against dark,
  sharp against blurred, the one tilted thing in a row of straight
...
ASKED-AS: stand out notice bold highlight busy cluttered pop grab poster billboard

ESSENCE: a picture is a guided walk — the eye enters, lands, and
  moves in jumps along lines, lights, and faces, and the designer
...
ASKED-AS: layout composition focal scanning reading webpage flow arrange gaze first glance

ESSENCE: depth on a flat page is drawn by shrinking — far things
  sit smaller and higher, parallel edges lean together toward a
...
ASKED-AS: drawing 3d realistic railroad tracks horizon road painting illusion sketch landscape

ESSENCE: color is three dials, not one — which color, how light,
  how pure — and how-light does the heavy lifting: a picture that
...
THREAD: photography (black-and-white survives because brightness
  ...
  light-dark one keeps reporting).
ASKED-AS: hue saturation value muddy washed out palette vibrant shading tone contrast

ESSENCE: no color is seen alone — every patch is judged against
...
ASKED-AS: matching swatch context lighting clashing comparison relative repaint dress illusion

ESSENCE: empty space is an active ingredient — the nothing around
...
ASKED-AS: white minimalist breathing room crowded clean declutter simple spacing padding blank

ESSENCE: simplicity is bought by subtraction — remove everything
  whose absence does not break the message, and stop one cut
  before it breaks.
...
ASKED-AS: less more minimal clutter overdesigned fancy trim excess bloat streamline essential

ESSENCE: freedom in design rides a hidden grid — edges align,
  spacings repeat, sizes come in a few fixed steps; the order is
...
ASKED-AS: crooked straight lined up tidy consistent template ruler sloppy neat uneven
