# 91 DEEP PEOPLE AND POWER — how groups actually work
Nothing here is physical. These are the laws of many people
handling one thing at once — what lets them, what stops them, and
the bill that arrives whichever way they choose.

ESSENCE: working together pays more than working alone, but only
  if the one who takes without giving can be made to lose. Where
  cheating is free, the honest are the ones who go under, and
  cooperation dies from the inside out.
...
ASKED-AS: cheating rules fairness punishment enforce group project slacker consequences trust cooperate

ESSENCE: punishing costs money; remembering is nearly free — so
  every group invents a name that carries its record, and lets the
  fear of a ruined name do a court's work for almost nothing.
...
ASKED-AS: reputation reviews ratings word of mouth references anonymous strangers repeat customer scam

ESSENCE: the strongest punishment most groups own is simply
  withdrawing cooperation — shunning, expulsion, the silence — and
  its force is exactly equal to how much the member depends on the
  group for a life.
...
ASKED-AS: shunned excluded kicked out banned blacklisted ignored group punishment expelled outcast membership

ESSENCE: some things cannot be withheld from those who did not pay
  — a lit street, a defended border, clean air — so each person's
  best private move is to enjoy it and let others fund it, and
...
ASKED-AS: free rider paying share taxes donations volunteers nobody contributes public benefit everyone uses

ESSENCE: a shared resource with private taking empties itself —
  each taker keeps the whole of what they take and suffers only a
  sliver of the damage, so taking more stays sensible for every
...
ASKED-AS: overfishing shared resource pasture groundwater depleted everyone takes tragedy commons quota limits

ESSENCE: some rules need no truth at all, only agreement — there is
  no better side of the road, only a shared one, and the entire
...
ASKED-AS: driving side road standards agree everyone metric time zones switch convention arbitrary

ESSENCE: owning is not a fact about a thing, it is a promise by
  everyone else to stay off it — and it lasts exactly as long as
...
ASKED-AS: property ownership deed title land rights stolen squatters enforce police investment building

ESSENCE: below the size where everyone knows everyone, judgement is
  cheaper and better than rules; above it, rules become cheaper
  even though they are worse in every single case — because a good
...
ASKED-AS: policies handbook written rules small company growing informal procedures case by case exceptions

ESSENCE: the deepest rule in any group is the one saying how the
  rules may be changed — settle that and disagreements stay
  disagreements; leave it open and every argument escalates into a
  fight about who is in charge.
...
ASKED-AS: constitution amend bylaws changing rules process founding charter procedure disputes who decides

ESSENCE: in a group where everyone talks to everyone, the pairs
  grow as the square of the head count — ten people have forty-five,
  a hundred have nearly five thousand — so the group builds a tree,
...
ASKED-AS: hierarchy org chart layers reporting flat management chain command levels bureaucracy communication

ESSENCE: handing work over means handing over what you know, and
  most of what you know cannot be said — so it comes back done
  differently. That difference is not a mistake; it is delegation's
  standing price, and refusing to pay it means doing everything
  yourself forever.
...
ASKED-AS: delegate handing off micromanaging trust employee did it differently instructions letting go control

ESSENCE: whoever acts on your behalf has their own life, and their
  reward is not your outcome — so the question is never whether they
  are loyal but what their day actually pays them for. A salesman on
...
ASKED-AS: commission incentives bonus conflict of interest realtor contractor lawyer fees advice motivated

ESSENCE: a number that was a good sign of the thing stops being one
  the moment rewards attach to it — people move the number, because
  moving the number is far easier than moving the thing, and the two
  quietly separate.
...
ASKED-AS: metrics targets gaming numbers quotas performance measured teaching test statistics incentive perverse

ESSENCE: bad news thins as it climbs, and nobody has to lie for it
  — each layer summarises, summarising means dropping things, and
  the safest thing to drop is the part that reflects badly on the
...
ASKED-AS: bad news upward boss reporting sugarcoat hiding problems status green dashboards surprise

ESSENCE: the member who reports harm inside a group is punished by
  the group even when the report is true — cohesion is a real asset
  and the report damages it — so truthful reporting has to be paid
...
ASKED-AS: whistleblower reported wrongdoing retaliation fired snitch loyalty covering up protection anonymous speaking out

ESSENCE: a meeting spends many people's time to build one shared
  picture, and it is worth it exactly when acting on different
  pictures would cost more. A group that meets constantly is usually
  one whose written record has failed.
...
ASKED-AS: meetings pointless time wasted status update sync calendar too many people email instead

ESSENCE: split a job among people and output multiplies — but each
  specialist quietly loses the ability to feed, clothe, or house
  themselves, so the group becomes rich and fragile in the very same
...
ASKED-AS: specialize skills jobs division labor dependent supply chain shortage career narrow generalist

ESSENCE: a middleman makes nothing and consumes nothing and looks
  like a toll — but he is doing real work: finding, vouching, holding
  stock, and carrying the risk in the gap between a maker and a buyer
  who have never met.
...
ASKED-AS: middleman broker agent commission cut out dealer wholesaler markup direct buying reseller

ESSENCE: nobody is in charge and the shelves fill — millions of
  people each judging only their own corner add up to an arrangement
  no committee could compute, because most of what they know is
...
ASKED-AS: market economy planning government shortages shelves stocked who decides supply invisible coordination

ESSENCE: a price is one number carrying news you never heard — a
  drought, a strike, a new mine — to somebody who does not need to
  know which. It says how much and never why, and that is exactly
...
ASKED-AS: prices rising why expensive shortage signal market information cost increase gouging supply news

ESSENCE: when there is not enough, something must decide who goes
  without, and the only choice is which currency the shortage is paid
  in — money, time in a queue, or an official's judgement. Each one
  favours a different sort of person.
...
ASKED-AS: rationing shortage waiting list queue lottery tickets scalping allocation who gets fair price

ESSENCE: many people each trade a small certain loss for cover
  against a rare ruinous one — nothing is created, the loss is only
...
ASKED-AS: insurance premium deductible claim pooled risk flood earthquake excluded coverage payout policy

ESSENCE: a debt moves goods from the future into the present, and the
  future has to actually deliver — every loan is a claim on work not
  yet done. A country's debts are a schedule of labour it has
  promised itself.
...
ASKED-AS: debt loans borrowing repay national deficit default bankruptcy mortgage future generations owe

ESSENCE: when the unit shrinks, every number written in it lies about
  the past — wages, pensions, contracts, and accounts are all measured
  with a ruler that changes length, so comparing across years without
...
ASKED-AS: inflation adjusted real wages salary comparison cost of living pension savings ruler

ESSENCE: a lead buys the means of keeping the lead — better tools,
  better contacts, better schooling for the children — so any starting
...
ASKED-AS: rich richer inequality gap widening inherited advantage head start compounding fair chance mobility

ESSENCE: a tax is what a group does after admitting nobody will
  volunteer — the goods everyone benefits from and no one will fund
  get funded by removing the choice. And whatever is taxed is
  discouraged, so a tax always buys money and a change of behaviour
  together.
...
ASKED-AS: taxes paying government services roads schools loopholes avoidance rates spending revenue fair share

ESSENCE: a decision with a named winner and a scattered nameless
  loser passes easily — the saved factory has a town and a photograph,
  while the price paid by everyone else is a few coins each, with no
...
ASKED-AS: subsidy tariff bailout jobs saved cost everyone hidden pennies lobbying protected industry

ESSENCE: corruption is arithmetic, not character — what a bribe is
  worth, against the punishment multiplied by the chance of being
  caught. Where discretion is wide, salaries thin, and detection weak,
  the honest official is the one behaving strangely, and honest people
  leave the job.
...
ASKED-AS: bribes corruption officials permits kickbacks paying under table police customs clean countries

ESSENCE: people answer far more to the chance of being caught than to
  the size of the penalty — mild and certain deters better than savage
...
ASKED-AS: punishment deterrent harsh sentences caught getting away enforcement odds fines crime prevention

ESSENCE: put a price on something that was being done out of duty or
  goodwill and you can get less of it — the fine for collecting a child
  late turned lateness into a purchase, and more parents came late once
...
ASKED-AS: fine late fee incentive backfired paying volunteers donation motivation duty obligation reward crowded

ESSENCE: a legal system is a group's settled fights written down —
  every dispute that was fought to the end becomes an answer the next
...
ASKED-AS: precedent case law rulings courts common law tradition rules written down disputes settled

ESSENCE: no contract covers everything, so real dealings run on the
  written terms plus a much larger unwritten expectation — and the day
  somebody insists on the letter only, the relationship is already
  finished.
...
ASKED-AS: contract terms not covered spirit letter work to rule technicality expectations unwritten dispute

ESSENCE: there is never enough enforcement for all the breaking, so
  every system catches a fraction and hopes the fraction frightens the
  rest. Which fraction gets chosen is the law that people actually
  learn.
...
ASKED-AS: enforcement police selective ticket speeding audit ignored laws books unenforced discretion targeted

ESSENCE: rules are written in the shape of the disaster that already
  happened — every clause has a body behind it — so protection always
  points backwards, and the next failure arrives through a door nobody
  wrote a rule for.
...
ASKED-AS: regulations written after disaster reactive rules new law prevented next time loophole unforeseen

ESSENCE: a guard for every citizen would cost more than the citizens
  produce — so obedience has to be mostly free or the regime is
  bankrupt before it is ever overthrown. Legitimacy is that discount,
...
ASKED-AS: legitimacy consent obey authority police everyone force costly regime collapse compliance voluntary

ESSENCE: the weaker parties combine against the strongest, which makes
  dominance quietly self-limiting — and the same arithmetic says the
  winning coalition begins dissolving the day the common threat does.
...
ASKED-AS: allies alliance enemy common threat coalition partners fell apart afterwards teamed up strongest

ESSENCE: you can steer what people argue about and the words they
  argue in far more easily than what they believe about their own week
  — the message loses to the empty shelf, the missing paycheck, and the
...
ASKED-AS: propaganda media brainwashing believe state news lies convinced people knew anyway censorship

ESSENCE: the worst-off rebel least — misery uses up everything a person
  has, and revolt takes slack, organisation, and above all an
  expectation. The rising comes first; the revolt arrives when the rise
  stops and the expectation stays.
...
ASKED-AS: revolution uprising protest poorest oppressed reform triggered expectations rising standards anger unrest

ESSENCE: an emergency justifies shortcuts, and the shortcuts outlive it
  — because whoever now holds the new power is the one who would have to
...
ASKED-AS: emergency powers temporary measures never lifted crisis government control state expanded rollback permanent

ESSENCE: the people inside an organisation depend on it, so its
  survival becomes an aim separate from its task; when the original
  problem is solved or simply leaves, the machine finds a new problem
  rather than stop.
...
ASKED-AS: agency committee outlived purpose still exists funding mission creep abolish obsolete department

ESSENCE: the people who built a thing know why every rule is there;
  those who inherit it see only the rules — so they either enforce them
...
ASKED-AS: why rule exists old policy nobody knows remove tradition pointless procedure reason forgotten

ESSENCE: a group can only take in new people as fast as it can teach
  them what the rules are for — go faster and it keeps the rules while
  losing the reasons, and within a few years it is a different group
...
ASKED-AS: hiring fast growth culture changed startup scaled diluted onboarding newcomers old timers rate

ESSENCE: the forms, the queues, the identical treatment of unidentical
  people — that is what it costs to make outcomes not depend on who you
  know. Every step that removes an official's discretion removes their
...
ASKED-AS: red tape paperwork forms bureaucracy rules rigid exceptions case fairness impersonal delays process

ESSENCE: trust is measured by what nobody has to do — where it is high,
  deals close on a word, doors stay unlocked, contracts stay short;
  where it is low, every transaction carries a guard, a lawyer, a
  deposit, and a delay. That difference is a tax on everything, printed
  on no receipt.
...
ASKED-AS: trust society honest handshake contracts lawyers deposits locks corruption expensive doing business

ESSENCE: the cheat takes the gain once; the suspicion it plants is
  billed to every honest person who comes after. That is why groups
  punish betrayal far past the size of the loss — they are not
...
ASKED-AS: broken promise scammed once bitten distrust deposits required everyone suffers reputation damage industry

ESSENCE: an unhappy member can leave or can complain, and the two work
  against each other — easy leaving drains away exactly the people who
  would have pushed for repair, so a group everyone can walk out of gets
  worse quietly.
...
THREAD: schools losing the parents who would have organised,
  ...
  comes back.
ASKED-AS: leaving quitting complaining feedback customers left school choice neighborhood decline stayed silent

ESSENCE: the people inside are present every day and the people served
  are not — rank, comfort, and internal peace are felt directly, while
  the mission arrives only as a report. So attention drifts inward, and
...
ASKED-AS: internal politics customers ignored self serving mission drift metrics gaming inward focused complacent

ESSENCE: a group of people with perfectly sensible individual
  preferences can have no sensible group preference — majorities can
  loop, A beating B beating C beating A — so the order of votes and the
  tie-break rule do real work that no honest count can remove.
...
ASKED-AS: voting elections runoff ranked choice agenda chair committee outcome fair majority tie

ESSENCE: a handover has to move two things at different speeds —
  authority, which must be given publicly and all at once, and knowledge,
  which is mostly unwritten and moves slowly. Give authority first and
  the successor rules blind; give knowledge first and the old one never
  leaves.
...
ASKED-AS: succession handover retiring founder replacement next leader training heir transition stepping down
