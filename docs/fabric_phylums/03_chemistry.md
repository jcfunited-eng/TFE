# 03 CHEMISTRY — physics one floor up
Every law here is the pull between charges wearing the costume of
substance. The periodic table is quantum law made into furniture.

ESSENCE: every chemical bond is electric — atoms stick by sharing,
...
ASKED-AS: tape sticky molecule attraction magnetism mixing dissolving paint welding grip cling

ESSENCE: the periodic table is a seating chart — element character
  repeats down each column because the outer-electron count
...
ASKED-AS: chart rows metals gases family pattern sodium potassium neon repeating school poster

ESSENCE: like dissolves like — charged solvents host charged
...
ASKED-AS: stain washing paint thinner nail polish remover alcohol vinegar sugar mixing shaking

ESSENCE: reactions rearrange, never create — every atom entering a
...
ASKED-AS: candle wax weight scale disappear vanish smoke fire wood heavier lighter melting

ESSENCE: every reaction has a price of admission — even a downhill
  reaction needs a starting shove before it runs. (activation
  energy)
...
ASKED-AS: match lighter striking kindling starter bonfire fuse candle lighting stove campfire wood

ESSENCE: heat is a hurry — warmer molecules collide harder and
  more often, so reactions roughly double in speed per ~10°C
...
ASKED-AS: freezer spoil rot milk sour leftovers thaw ripen bananas meat ice summer

ESSENCE: a catalyst is a matchmaker — it offers a cheaper path
  over the admission price, hurries the deal, and walks away
...
ASKED-AS: car exhaust platinum digestion washing powder helper shortcut booster fumes cleaner unchanged

ESSENCE: acid and base are one currency with opposite signs —
  acids shed charged hydrogen, bases soak it up; mixed, they
...
THREAD: cooking (acid cuts fat; baking soda's burp is this
  ...
  field-sized antacid).
ASKED-AS: vinegar lemon heartburn stomach fizz sour lye bleach battery sting tablet indigestion

ESSENCE: burning, rusting, and breathing are one reaction at three
...
ASKED-AS: flame oxygen air smother extinguish iron corrode charcoal grill tarnish apple brown

ESSENCE: reactions run both directions at once and settle where
  the two speeds match — a tug-of-war standing still, not a job
