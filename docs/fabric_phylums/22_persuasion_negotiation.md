# 22 PERSUASION AND NEGOTIATION — how minds move minds
The honest mechanics, described, not endorsed. The CANNOT lines
carry the limits, and the limits are most of the truth.

ESSENCE: people decide by feeling and then hire reasons — winning
  persuasion reaches the feeling; the reasons are supplied so the
  decision can be defended aloud.
...
THREAD: money (ads sell feelings and mention the product), law
  ...
  because it never wakes the defenses).
ASKED-AS: convincing appeal debating changing minds voting gut heart marketing rationalizing speeches

ESSENCE: lasting persuasion is self-persuasion — conclusions
  people reach are held far harder than conclusions they receive;
...
ASKED-AS: leading realize themselves advice ignored nagging lecturing kids own idea guiding

ESSENCE: a small gift opens a large door — felt debt is out of all
...
THREAD: diplomacy (concessions are traded, never given), money
  ...
  old as prayer).
ASKED-AS: freebies charity address labels mints tips salesman obligation upselling coupons

ESSENCE: two borrowed compasses steer most choices — what runs out
  must be valuable, and what everyone picks must be right; both
...
ASKED-AS: limited time offer sale countdown bestseller popular ratings stars trending fomo

ESSENCE: people steer to match their own past statements — a small
  public yes today tilts the big yes tomorrow, because
...
ASKED-AS: foot door commitment petitions pledges backing down flip flopping sticking promises

ESSENCE: choices flip with wording while facts hold still — "nine
  in ten survive" and "one in ten die" move different decisions
...
ASKED-AS: spin glass half full positive negative labels headlines slant biased percentages

ESSENCE: the first number spoken bends the whole negotiation
  toward itself — even absurd anchors drag the counter-offers,
  even when both sides know the trick.
...
ASKED-AS: haggling car dealer sticker retail salary asking high lowball starting bid

ESSENCE: negotiation is overlap-finding — each side has a
  walk-away line, talk probes for the space between them, and the
...
ESSENCE: positions are demands; interests are the reasons under
  them — deals dead at the position layer often open one layer
  down, where different hungers share one arrangement (two
  sisters, one orange: one wanted juice, one wanted peel).
...
THREAD: diplomacy (a peninsula returned but demilitarized fed both
  ...
  built of non-money terms).
ASKED-AS: really want underlying needs motives creative solutions stubborn impasse deeper
