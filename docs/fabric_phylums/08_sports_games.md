# 08 SPORTS AND GAMES — law kept voluntarily, for the joy of it
A game is a small world built out of rules and entered on purpose.
The fabric practiced in the open, with a scoreboard.

ESSENCE: the rules ARE the game — take the constraints away and no
  game remains, only motion; play exists because something is
...
ASKED-AS: cheating offside boundaries lines playground pickup basketball golf par nets fences scoring

ESSENCE: a contest measures nothing unless it starts fair — same
  line, same gun, same gear; the fair start is not politeness, it
...
ASKED-AS: handicap lanes staggered coin toss doping advantage level playing field equal footing

ESSENCE: follow-through is physics, not flourish — force feeds the
  ball only during contact, so the swing that continues through
  the strike was still at full speed at it; the swing that stops
...
THREAD: martial arts (strike through the target, not at it),
  ...
  stroke in the water).
ASKED-AS: golf tennis serve baseball bat punching stopping short chopping finish pitching bowling

ESSENCE: practice buys automation, and automation frees attention —
  the stroke rehearsed to self-running costs no thought, and the
  freed thought is what plays strategy; amateurs think about their
...
ASKED-AS: autopilot habit multitasking texting focus concentration typing walking chewing gum instinct juggling

ESSENCE: strategy is a currency exchange — space for time,
  material for initiative, position for tempo; games are won by
...
ASKED-AS: sacrifice tempo opening swap risking bargain pawn queen bishop poker chips betting

ESSENCE: records fall in shrinking slices — early decades lop
  whole seconds, late ones fight over hundredths — because
  performance climbs toward walls set by the body's physics (the
  mile fell for a century, then froze for decades).
...
THREAD: engineering (engines chasing the ceiling physics set on
  ...
  exactly where).
ASKED-AS: world olympics marathon sprint limits plateau human peak swimming hundredths stopwatch faster

ESSENCE: rules do not keep themselves — past a friendly, every
  game needs a referee, because the payoff for cheating grows with
...
ASKED-AS: umpire foul flag penalty video review honor system enforcement disputes officiating calls

ESSENCE: home teams win more, everywhere ever measured (roughly
  54-60% across sports) — the home side knows the bounce, the
  light, the wind, sleeps in its own bed, and the crowd leans on
  the referee's close calls.
...
ASKED-AS: stadium cheering travel jet lag familiar court turf booing fans arena roar

ESSENCE: one game belongs to luck, a season belongs to skill —
  chance dominates short contests and washes out over many; upsets
...
ASKED-AS: underdog streak fluke lucky playoffs series championship tournament rankings standings hot hand

ESSENCE: a game is an argument with an ending built in — final
  whistle, checkmate, match point; the settlement is the mercy
...
ASKED-AS: overtime sudden death tie draw clock buzzer rematch forfeit stalemate innings deadline
