# 55 DEEP COLUMN — THE BODY'S EVERYDAY MYSTERIES
Middle floors for the small riddles a body asks daily. Where the
science is honestly unsettled the entry says UNSURE — the body
keeps more open cases than any field.

ESSENCE: a yawn spreads by sight, sound, even reading the word —
  and after a century of study its job is genuinely unsettled
...
ESSENCE: bath wrinkles are commanded, not soaked — nerves order
  the fingertip's vessels to shrink and pull the skin into
  drainage treads, rain tires for wet grip (they measurably
...
ESSENCE: goosebumps are the fur-raising order sent to fur we no
  longer have — a tiny muscle at each hair pulls it upright to
...
THREAD: the living world (the puffed bird, the arched cat — done
  ...
  UNSURE why).
ASKED-AS: goosebumps chills hair standing arm cold scary music spooky shiver frisson bumps

ESSENCE: spinning dizziness is an argument between instruments —
  the ear keeps level with fluid-filled rings, and the fluid
  swirls on after you stop — the ear swears you are still
...
ESSENCE: brain freeze is the roof of the mouth chilled too fast —
  its vessels clamp and rebound, and the alarm rides a shared
...
THREAD: medicine (heart attacks billed to the left arm — the
  ...
  by the gap).
ASKED-AS: ice cream headache brain freeze slushie milkshake cold drink forehead gulp popsicle fast

ESSENCE: a paper cut is a small wound in the worst place — the
  fingertip carries the body's densest touch wiring; the ragged
  shallow tear lays endings open, bleeds too little to seal, and
...
THREAD: craft (braille lives under fingertips on the same
  ...
  slicing).
ASKED-AS: paper cut finger envelope sting tiny hurts so much throbbing cardboard slice bandaid

ESSENCE: you cannot tickle yourself because the brain forecasts
  every touch it orders and subtracts the forecast — tickle is
  surprise, and you cannot surprise the author of the plan (a
...
THREAD: engineering (noise-cancelling headphones subtract a
  ...
  out).
ASKED-AS: tickle yourself why not armpit feet ribs laugh squirm ticklish surprise trying

ESSENCE: a hiccup is a two-part reflex — the breathing muscle
  yanks in a sudden breath and the throat slams shut on it (the
...
ESSENCE: a stubbed toe hurts in two waves because pain runs on
  two wires — an insulated fast line reports in a blink, a bare
...
ESSENCE: morning stiffness is the chemistry of stillness — joint
  oil thins when stirred and thickens when parked (ketchup's
  trick), and the spine's discs re-drink overnight (you wake
...
THREAD: machines (engines run rough till the oil warms), medicine
  ...
  tide).
ASKED-AS: stiff morning creaky knees back waking stretch achy joints limber old rusty
