# 78 ATTENTION AND HOLDING — the narrow gate everything passes through

One narrow doorway stands in front of every thought. What gets
through gets thought about; what does not may as well never have
happened. These are the laws of that doorway.

ESSENCE: attention is one lamp, not a rack of them — it lights one
...
ESSENCE: the hands of the mind are small — about four things held
...
ESSENCE: effort draws on something real and the well goes down. A
...
ESSENCE: whatever is practised long enough drops below the lamp and
  runs without it. Reading, changing gear, tying a lace each cost
...
ESSENCE: an interruption costs far more than the minute it took.
  The half-built thing is dropped, and rebuilding it means going
  back out to the page, the screen, the notes — the thread was never
...
ESSENCE: whatever arrives first builds the room everything after is
  read inside — the first price named, the first explanation
...
ESSENCE: an hour of study spread over a week holds; the same hour
...
ESSENCE: forgetting is the sweeping, not the breakage. A mind that
  kept every meal and every drive would have to search all of it to
...
ESSENCE: what gets noticed is set by what is being hunted. Two
  people walk one street and come back with different streets — one
...
ESSENCE: tiredness does not only slow a mind, it narrows it. The
  tired searcher takes the first answer that will do and stops — and
...
ESSENCE: a name is a handle. A difference you can feel but cannot
  say slips out of the hand every time you reach; give it a word and
  it becomes a thing you can carry, compare, hand to someone else,
