# 73 ACTS I POSSESS — the small doings everything else is built from

By the law of procedures, nothing can be built from acts nobody
possesses. These are the acts themselves — the counting-up and
counting-down of every method. Each names itself in the words a
...
ACT: walk-places
ASKED-AS: work the places right to left one place at a time each column smallest largest
...
ESSENCE: I can take one small number away from another by
