...
## 9. Amendment (C1, 2026-09-15 night): her own voice opens events of its own

§3's "her own voice heard back does not open an event" is amended: her own voice heard back runs through the same gate law in a gate of its own (its open event carried in her body like the room's), and its events are kept in a store of her own sounds (64 by recency), apart from the room's. Nothing else in the gate changes; the room's events are as before.
