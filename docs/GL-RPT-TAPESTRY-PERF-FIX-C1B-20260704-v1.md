...
Fresh verified backup, then `tools/deploy_dsf_ai.sh` from an isolated
worktree pinned at this fix on top of `aabb52f` (not c1a's later,
unratified P2 commits). Single clean attempt.
