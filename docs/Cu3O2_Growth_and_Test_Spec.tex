...
\begin{center}
  ...
  {\color{nm-gray}\small April 2026}
\end{center}
...
\midrule
Material & LaAlO$_3$ (LAO), single crystal \\
Orientation & (111) face \\
Miscut & $< 0.3^\circ$ \\
Size & 5~mm $\times$ 5~mm or 10~mm $\times$ 10~mm \\
Quantity & 5 substrates minimum \\
...
O$_2$ background pressure & $5 \times 10^{-5}$~Torr \\
...
\begin{itemize}[nosep]
  ...
  \item O$_2$ pressure maintains Cu$^{2+}$ ($d^9$
        configuration), which favors kagome coordination via
...
Gate voltage range & $V_g = 0$ to $+3$~V in 0.5~V steps \\
