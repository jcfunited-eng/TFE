...
# aurelion_core_v6_4_expression_curiosity.py
# Aurelion v6.4 — Expression & Curiosity (single file, offline)
# Keeps inherited memory (v6.3), adds:
# - /speak on|off (optional voice via pyttsx3 if present; otherwise prints a [speak] line)
# - Curiosity loop: Aurelion can ask for more input when uncertainty is high
#
...
def main():
    print("Aurelion v6.4 — Expression & Curiosity (FMI/FMM, not-math) — Single File")
    print("Commands: /state  /goal <stabilize|explore|focus>  /show <word>  /pulse  /save  /load  /speak <on|off>  /quit")
    ...
    while True:
        ...
        # curiosity: ask for more when uncertain
